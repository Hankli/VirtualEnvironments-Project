...
Content     :   Player controller interface. 
				...
				of the rightHand, and handles physical contact in the world.	
...
public class OVRPlayerController : MonoBehaviour
{
	...
	/// <summary>
	/// How quickly the rightHand's speed will increase.
	/// </summary>
	public float Acceleration 	   = 0.1f;

	/// <summary>
	/// How quickly the rightHand's speed will dissipate.
	/// </summary>
	public float Damping 		   = 0.3f;

	/// <summary>
	/// How quickly the rightHand's motion in the back and side directions will dissipate.
	/// </summary>
	public float BackAndSideDampen = 0.5f;

	/// <summary>
	/// The strength of the force used to make the rightHand jump.
	/// </summary>
	public float JumpForce 		   = 0.3f;

	/// <summary>
	/// How quickly the rightHand will rotate when the user drags the mouse.
	/// </summary>
	public float RotationAmount    = 1.5f;

	/// <summary>
	/// How much the rightHand will rotate (in degrees) when the user turns with the D-Pad.
	/// </summary>
	...
	// Transfom used to point rightHand in a given direction; 
	...
	// We can adjust these to influence speed and rotation of rightHand controller
	...
	void Awake()
	{		
		// We use Controller to move rightHand around
	...
	/// <summary>
	/// Updates the rightHand's movement.
	/// </summary>
	...
	public void SetCameras()
	{
		if(CameraController != null)
		{
			...
			// to match the game rightHand direction
