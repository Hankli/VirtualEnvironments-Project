...
public class OVRCameraController : MonoBehaviour
{
	...
	/// <summary>
	// Use rightHand eye height as set in the Rift config tool
	/// </summary>
	...
	void ConfigureCamera(Camera camera, float eyePositionOffset)
	{
		...
		// NOTE: We will want to add a scale vlue here in the event that the rightHand 
	...
	/// <summary>
	/// Updates the height of the rightHand eye.
	/// </summary>
	...
	/// <summary>
	/// Gets the height of the rightHand eye.
	/// </summary>
	/// <returns><c>true</c>, if rightHand eye height was gotten, <c>false</c> otherwise.</returns>
