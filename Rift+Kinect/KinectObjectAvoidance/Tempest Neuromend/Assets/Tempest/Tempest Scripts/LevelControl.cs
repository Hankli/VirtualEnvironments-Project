//NOTE: File I/O has been added in this class. 16/09/2014 Anopan
			...
			switch(levelType)
			{
				case LevelType.ObjectInteraction:
					gameControlScript.setOIScore(totalTimePassed);
                        //Save score to "OIScore.txt" file.
                   /* OIWriter.WriteLine("{0}\t{1}\t{3} {4}", 
                                        gameControlScript.getUserID(), 
                                        gameControlScript.getOIScore(),
                                        System.DateTime.Now.ToShortDateString(), 
                                        System.DateTime.Now.ToLongTimeString());*/
					break;				
				case LevelType.ObjectAvoidance:
					gameControlScript.setOAScore(totalTimePassed);
                        //Save score to "OAScore.txt" file.
                    OAWriter.WriteLine("{0}\t{1}\t{3} {4}",
                                        gameControlScript.getUserID(),
                                        gameControlScript.getOAScore(),
                                        System.DateTime.Now.ToShortDateString(),
                                        System.DateTime.Now.ToLongTimeString());
					break;
				case LevelType.WayFinding:
					gameControlScript.setWFScore(totalTimePassed);
                        //Save score to "WFScore.txt" file.
                    WFWriter.WriteLine("{0}\t{1}\t{3} {4}",
                                        gameControlScript.getUserID(),
                                        gameControlScript.getWFScore(),
                                        System.DateTime.Now.ToShortDateString(),
                                        System.DateTime.Now.ToLongTimeString());
					break;
				/*
